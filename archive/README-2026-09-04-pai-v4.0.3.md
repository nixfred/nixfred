> **Archived 2026-09-04.** This was the NixFred profile README before the Omarchy × AI rewrite.
> Kept for the record — the live version is at [../README.md](../README.md).

---

<div align="center">

<img src="../assets/profile-hero.svg" alt="Connected systems map linking AI memory, algorithms, infrastructure, tools, and public experiments around NixFred" width="100%">

# Hey, I'm Fred

### AI Infrastructure Architect building systems that remember, verify, and improve.
...
PAI is an open architecture that wraps Claude Code with skills, hooks, memory, and a continuously upgrading algorithm. It's not a chatbot — it's scaffolding that makes AI reliable, repeatable, and personal.   The goal is Zero-shot-inferring.

```mermaid
flowchart TB
    PAI["Personal AI Infrastructure"] --> SKILLS["Skills<br/>domain expertise"]
    PAI --> HOOKS["Hooks<br/>lifecycle + safety"]
    PAI --> MEMORY["Memory<br/>persistent context"]
    PAI --> ALGO["Algorithm<br/>repeatable execution"]
    PAI --> AGENTS["Agents<br/>specialized work"]
